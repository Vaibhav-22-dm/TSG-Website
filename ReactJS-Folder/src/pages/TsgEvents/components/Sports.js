...
import API from "../../../api/index"
  function Sports (){
    ...
    useEffect(() => {
      API.get("/tsgevents/?param=sports")
        .then((res) => {
  ...
  return(<>
    ...
    <div><div className={classes.heading}><span className={classes.events}> Sport Events</span><Link to="/events" className={classes.back} ><img src={back}></img></Link></div>
